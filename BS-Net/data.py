...
def labelVisualize(num_class,color_dict,img):
    ...
    return img_out / 255
def read_line_Npy():
    train_image = np.load('data/train/train.npy')
    train_sobel = np.load('data/train/train_sobel.npy')
    train_GT    = np.load('data/train/train_label.npy')
    coastline_train_GT = np.load('data/train/train_line_label.npy')
    valid_image = np.load('data/valid/valid.npy')
    valid_sobel = np.load('data/train/valid_sobel.npy')
    valid_GT = np.load('data/valid/valid_label.npy')
    coastline_valid_GT = np.load('data/train/valid__line_label.npy')
    return train_image, train_GT,valid_image, valid_GT
def readNpy():
    train_image = np.load('data/train/train_mn.npy')
    train_GT    = np.load('data/train/train_label.npy')
    #coastline_train_GT = np.load('data/train/coastline_train_groundTruth_arr.npy')
    valid_image = np.load('data/valid/valid_mn.npy')
    valid_GT = np.load('data/valid/valid_label.npy')
    #coastline_valid_GT = np.load('data/train/coastline_valid_groundTruth_arr.npy')
    return train_image, train_GT,valid_image, valid_GT
